...
<body>
<h1>View your placed orders here.</h1>
...
<form method="POST" action="placedorder.jsp">
    ...
    <a href="placedorder.jsp">Reset Filter</a>
</form>
<br>
<h4>Note: Here are all placed orders.<br></h4>
<h4>All final submitted orders cannot be modified.</h4>
<%
    try {
...
<%
                ...
                List<order> orderList = orderDBManager.findAllOrder(userid, "placed");
